...
class ConvnetBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        z = nn.Conv2d(num_channels, num_channels, (3, 3), padding=(1, 1))(u)
...
class PixelCNN(nn.Module):
    def __init__(self, capacity=32, depth=9, *args, **kwargs):
        ...
        for i in range(depth):
            self.resnet.append(MaskedConvnetBlock(capacity))
...
class IAF(nn.Module):
    def __init__(self, filters, depth=9, *args, **kwargs):
        ...
        resnet = []
        for i in range(9):
            resnet.append(MaskedConvnetBlock(filters))
...
class VAEEncoder(nn.Module):
    def __init__(self, capacity=32, depth=9, flows=0, *args, **kwargs):
        ...
        for f in range(flows):
            self.flows.append(IAF(capacity))
